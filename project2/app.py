...
def create_app():
    ...
    from views2 import main, plyy, api_main, api_plyy, api_c_plyy, api_search_plyy, api_search_curator
    ...
    app.register_blueprint(api_search_plyy, url_prefix='/api/search')
